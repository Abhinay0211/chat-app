...
export const get = query({
    ...
    handler: async (ctx, args) => {
      ...
      await ctx.db.query("conversationMembers").withIndex("by_memberId", q => q.eq("memberId", currentUser._id))
      .collect()
      ...
      await Promise.all(conversations.map
        (async (conversation, index)=>{
            ...
            await ctx.db.query("conversationMembers").withIndex("by_conversationId", q =>
                q.eq("conversationId", conversation?._id)).collect();
